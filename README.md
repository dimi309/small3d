...
is that on MacOS, in full screen mode, performance used to suffer, so windowed
mode is enforced. This only concerns Apple computers. On Apple mobile devices 
(iOS) small3d runs fine.
